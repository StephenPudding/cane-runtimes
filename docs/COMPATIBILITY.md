...
| Unity | Unity 6000.3+ on Windows; Built-in, URP/HDRP 17.3–17.x | Linear project color space; see the engine integration guide for pass setup |
| C++ Core | C++17, Runtime JSON/CANEB/Atlas 1.0 and Runtime API 1.3 | Native engine-neutral Core |
| Godot | Godot 4.5 native ABI, Windows x64; Compatibility and Forward+ | Requires HDR 2D; does not require .NET |
