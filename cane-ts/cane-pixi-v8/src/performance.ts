...
export interface CanePixiFrameTimeSnapshotV1 {
...
/** Fixed-capacity ring buffer; recording a frame performs no allocation. */
export class CanePixiFrameTimeWindowV1 {
  ...
  /** Cold-path statistical snapshot. It allocates and sorts one typed array. */
  snapshot(): CanePixiFrameTimeSnapshotV1 {
...
function percentile(sorted: Float64Array, percentileValue: number): number {
