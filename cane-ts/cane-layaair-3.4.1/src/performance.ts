...
export interface CaneLayaFrameTimeSnapshotV1 {
...
/** Fixed-capacity ring buffer; recording a stable frame allocates nothing. */
export class CaneLayaFrameTimeWindowV1 {
  ...
  /** Cold-path snapshot; allocates and sorts one typed array. */
  snapshot(): CaneLayaFrameTimeSnapshotV1 {
